...
int main()
{
    ...
    cout << "fullTree.idealPrune(10) = "  << fullTree.idealPrune(10) << endl;
    cout << "fullTree.idealPrune(100) = "  << fullTree.idealPrune(100) << endl;
    cout << "fullTree.idealPrune(1000) = "  << fullTree.idealPrune(1000) << endl;
    cout << "fullTree.idealPrune(10000) = " << fullTree.idealPrune(10000) << endl;
    cout << "fullTree.idealPrune(100000) = " << fullTree.idealPrune(100000) << endl;
