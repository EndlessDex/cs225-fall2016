...
class BinaryTree
{
  ...
  private:
    ...
    bool isOrdered(Node* subRoot, int min, int max) const;
    void printPaths(Node* subRoot, vector<Node*> list) const;
    void sumDistances(Node* subRoot, int& counter, int& sum) const;
