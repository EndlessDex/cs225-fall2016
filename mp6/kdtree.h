...
class KDTree
{
  ...
  private:
    ...
    void sort(int dim, int min, int max);
    void select(int dim, int min, int max, int mIdx);
    int partition(int dim, int min, int max, int pIdx);
    Point<Dim> dingDong(const Point<Dim>& query, int curMed,
